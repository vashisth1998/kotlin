...
abstract class KotlinWithGradleConfigurator : KotlinProjectConfigurator {
    ...
    companion object {
        ...
        private val VERSION = String.format("ext.$KOTLIN_VERSION_PROPERTY_NAME = '%s'", VERSION_TEMPLATE)
        ...
        fun addElementsToProjectGSKFile(file: KtFile, version: String): Boolean {
            ...
            file.getBuildScriptBlock()?.apply {
                addExpressionIfMissing("extra[\"$KOTLIN_VERSION_PROPERTY_NAME\"] = \"$version\"", true)
